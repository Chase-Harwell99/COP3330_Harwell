...
class BodyMassIndexTest {
    ...
    void testUnderweightBMI() {
        ...
        assertEquals("Underweight", e.category(15.2));
    }
    ...
    void testNormalBMI() {
        ...
        assertEquals("Normal", e.category(21.3));
    }
    ...
    void testOverweightBMI() {
        ...
        assertEquals("Overweight", e.category(28.3));
    }
    ...
    void testObesityBMI() {
        ...
        assertEquals("Obesity", e.category(31.2));
    }
